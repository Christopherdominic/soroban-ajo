...
pub enum AjoError {
    ...
    /// Group name exceeds maximum length of 64 characters.
    MetadataNameTooLong = 21,

    /// Group description exceeds maximum length of 256 characters.
    MetadataDescriptionTooLong = 22,

    /// Group rules exceed maximum length of 512 characters.
